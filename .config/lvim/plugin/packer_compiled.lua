...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/user/.local/share/lunarvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/user/.local/share/lunarvim/site/pack/packer/start/nvim-lsp-installer",
